...
const MODELS = [
  ...
  },
  {
    ...
    status: "development",
    icon: "waves",
    summary: "Extending the plankton biomass models up the food chain — estimating food chain length and tertiary production fields across the Bay of Bengal, validated against OCM-3 ocean colour products.",
    stack: ["Trophic Transfer", "OCM-3 Validation", "Python", "Seasonal Fields"],
    metrics: [
      { label: "Scope", value: "Food chain length" },
      { label: "Status", value: "Manuscript stage" }
    ],
    url: ""
  }
];
